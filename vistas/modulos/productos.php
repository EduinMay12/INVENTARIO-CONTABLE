             ...
             <div class="form-group row">
              ...
              <div class="col-xs-6">
                ...
                <div class="input-group">
                  ...
                  <select class="form-control input-lg" id="unidadMedida" name="unidadMedida" required>

                      <option value="">Medida unitaria</option>
             ...
             <div class="form-group row">
              ...
              <div class="col-xs-6">
                ...
                <div class="input-group">
                  ...
                  <input type="text" class="form-control input-lg" id="editarStock" name="editarStock" min="0" placeholder="Stock" required>
